    ...
    Button: {
      ...
      variants: {
        ...
        orange: (props) => ({
          ...
          color: "white",
          _focus: { bg: mode("orange.500", "orange.400")(props) },
          _active: { bg: mode("orange.500", "orange.400")(props) },
          _hover: { bg: mode("orange.600", "orange.400")(props) },
        }),
        blue: (props) => ({
          bg: mode("blue.500", "blue.400")(props),
          color: "white",
          _focus: { bg: mode("blue.500", "blue.400")(props) },
          _active: { bg: mode("blue.500", "blue.400")(props) },
          _hover: { bg: mode("blue.600", "blue.500")(props) },
        }),
        purple: (props) => ({
          bg: mode("purple.500", "purple.400")(props),
          color: "white",
          _focus: { bg: mode("purple.500", "purple.400")(props) },
          _active: { bg: mode("purple.500", "purple.400")(props) },
          _hover: { bg: mode("purple.600", "purple.500")(props) },
        }),
        darkBrand: (props) => ({
        ...
        action: (props) => ({
          ...
          color: mode("brand.500", "white")(props),
          _focus: { bg: mode("secondaryGray.300", "brand.400")(props) },
